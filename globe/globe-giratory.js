...
DAT.Globe = function(container, colorFn) {
  ...
  var imgDir = '';//Here was img but that cause errors
  ...
  function init() {
    ...
    // ORIGINAL VALUES: camera = new THREE.PerspectiveCamera(26, w / h, 1, 10000);
    camera = new THREE.PerspectiveCamera(26, w / h, 2, 10000);
    ...
    uniforms['texture'].value = THREE.ImageUtils.loadTexture(imgDir+'/globe/world_black.jpg');
